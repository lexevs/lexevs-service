...
public class RestUriResolver implements UriResolver, InitializingBean {
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.uri.UriResolver#idToUri(java.lang.String, edu.mayo.cts2.framework.service.lexevs.uri.UriResolver.IdType)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.uri.UriResolver#idToName(java.lang.String, edu.mayo.cts2.framework.service.lexevs.uri.UriResolver.IdType)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.uri.UriResolver#idToBaseUri(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.uri.UriResolver#idAndVersionToVersionUri(java.lang.String, java.lang.String, edu.mayo.cts2.framework.service.lexevs.uri.UriResolver.IdType)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.uri.UriResolver#idAndVersionToVersionName(java.lang.String, java.lang.String, edu.mayo.cts2.framework.service.lexevs.uri.UriResolver.IdType)
	 */
