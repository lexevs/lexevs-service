...
*/
package edu.mayo.cts2.framework.service.lexevs.service.valueset;
...
public class ValueSetTransform
		extends
		AbstractBaseTransform<ValueSetCatalogEntry, ValueSetDefinition, ValueSetCatalogEntrySummary, ValueSetDefinition> {

	@Resource
	private ValueSetNameTranslator valueSetNameTranslator;

	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.transform.LexEvsToCTS2Transformer#transformFullDescription(java.lang.Object)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.transform.LexEvsToCTS2Transformer#transformSummaryDescription(java.lang.Object)
	 */
	@Override
