...
public interface CodeSystemVersionBulkDownloader {
	 ...
	 */
	void download(OutputStream outputStream, Set<CodingSchemeReference> codingSchemes,
                  Set<CodingSchemeReference> excludedCodingSchemes, List<String> fields, char separator);

	void download(PrintWriter printWriter, Set<CodingSchemeReference> codingSchemes,
				  Set<CodingSchemeReference> excludedCodingSchemes, List<String> fields, char separator);
}
