...
*/
package edu.mayo.cts2.framework.service.lexevs.bulk.codesystemversion;

import edu.mayo.cts2.framework.service.lexevs.bulk.AbstractBulkDownloader;
import edu.mayo.cts2.framework.service.lexevs.bulk.Extractor;
...
public class SearchExtensionBulkDownloader 
	...
	/* (non-Javadoc)
	 * @see edu.mayo.cts2.framework.service.lexevs.bulk.controller.BulkDownloader#download(java.io.OutputStream, java.util.Set, java.util.List, java.lang.String)
	 */
	...
	public void download(PrintWriter writer, Set<CodingSchemeReference> codingSchemes, Set<CodingSchemeReference> excludedCodingSchemes, List<String> fields, char separator) {
		ResolvedConceptReferencesIterator itr;
		...
		this.doWrite(writer, new ResolvedConceptReferencesIteratorAdapter(itr), separator, fields);
