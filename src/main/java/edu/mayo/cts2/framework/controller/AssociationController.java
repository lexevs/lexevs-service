...
import edu.mayo.cts2.framework.service.core.config.ServerContextImpl;
...
public class AssociationController extends AbstractMessageWrappingController {
	 ...
	 */
	@GetMapping(PATH_CHILDREN_ASSOCIATIONS_OF_ENTITY)
	public Object getChildrenAssociationsOfEntity(
		...
		return this.getChildrenAssociationsOfEntityImpl(
				httpServletRequest, 
				restReadContext,
				queryControl,
				null, 
	 ...
	 * @return the children associations of entity
	 */
//	@PostMapping(value=PATH_CHILDREN_ASSOCIATIONS_OF_ENTITY)
	public Object getChildrenAssociationsOfEntityImpl(
			HttpServletRequest httpServletRequest,
			RestReadContext restReadContext,
			QueryControl queryControl,
	 ...
	 */
	@GetMapping(PATH_ASSOCIATIONS_OF_CODESYSTEMVERSION)
	 ...
	 */
	@PostMapping(value=PATH_ASSOCIATIONS)
	...
	@GetMapping(PATH_ASSOCIATIONBYID)
	...
	@GetMapping(PATH_ASSOCIATION_OF_CODESYSTEMVERSION_BY_URI)
	...
	@GetMapping(PATH_ASSOCIATIONBYURI)
	 ...
	 */
	@GetMapping(PATH_GRAPH_OF_CODESYSTEMVERSION)
	//TODO: Not complete
	...
	@GetMapping(PATH_SUBJECTOF_ASSOCIATIONS_OF_ENTITY)
	 ...
	 */
	@PostMapping(PATH_SUBJECTOF_ASSOCIATIONS_OF_ENTITY)
	public Object getSubjectOfAssociationsOfEntity(
			HttpServletRequest httpServletRequest,
			RestReadContext restReadContext,
			QueryControl queryControl,
	...
	@GetMapping(PATH_TARGETOF_ASSOCIATIONS_OF_ENTITY)
	...
	@PostMapping(PATH_TARGETOF_ASSOCIATIONS_OF_ENTITY)
	public Object getTargetOfAssociationsOfEntity(
			HttpServletRequest httpServletRequest,
			RestReadContext restReadContext,
			QueryControl queryControl,
	...
	@GetMapping(PATH_PREDICATEOF_ASSOCIATIONS_OF_ENTITY)
	...
	@PostMapping(PATH_PREDICATEOF_ASSOCIATIONS_OF_ENTITY)
	public Object getPredicateOfAssociationsOfEntity(
			HttpServletRequest httpServletRequest,
			RestReadContext restReadContext,
			QueryControl queryControl,
...
//	@PutMapping(value=PATH_ASSOCIATIONBYID)
...
//	}
//	
//	@DeleteMapping(value=PATH_ASSOCIATIONBYID)
