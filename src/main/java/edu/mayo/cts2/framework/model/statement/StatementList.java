...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<StatementListEntry> _entryList;
    ...
    public StatementList() {
        super();
        this._entryList = new java.util.ArrayList<StatementListEntry>();
    }
    ...
    public void addEntry(
            final StatementListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends StatementListEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public StatementListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public StatementListEntry[] getEntry(
        ...
        StatementListEntry[] array = new StatementListEntry[0];
     ...
     */
    public java.util.List<StatementListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends StatementListEntry> iterateEntry(
    ) {
     ...
     */
    public StatementListEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final StatementListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<StatementListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<StatementListEntry> entryList) {
