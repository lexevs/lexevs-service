...
implements java.io.Serializable
{
     ...
     * Field _memberList.
     */
    private java.util.List<ChangeableResource> _memberList;
    ...
    public ChangeSet() {
        ...
        this._memberList = new java.util.ArrayList<ChangeableResource>();
    }
    ...
    public void addMember(
            final ChangeableResource vMember)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ChangeableResource> enumerateMember(
    ) {
     ...
     * the given index
     */
    public ChangeableResource getMember(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ChangeableResource[] getMember(
        ...
        ChangeableResource[] array = new ChangeableResource[0];
     ...
     */
    public java.util.List<ChangeableResource> getMemberAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ChangeableResource> iterateMember(
    ) {
     ...
     */
    public ChangeableResource removeMemberAt(
            final int index) {
     ...
     */
    public void setMember(
            final ChangeableResource[] vMemberArray) {
        //-- copy array
        _memberList.clear();
     ...
     */
    public void setMember(
            final java.util.List<ChangeableResource> vMemberList) {
        // copy vector
        this._memberList.clear();
    ...
    public void setMemberAsReference(
            final java.util.List<ChangeableResource> memberList) {
