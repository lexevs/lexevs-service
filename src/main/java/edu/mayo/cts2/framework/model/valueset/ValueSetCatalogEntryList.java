...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ValueSetCatalogEntryListEntry> _entryList;
    ...
    public ValueSetCatalogEntryList() {
        super();
        this._entryList = new java.util.ArrayList<ValueSetCatalogEntryListEntry>();
    }
    ...
    public void addEntry(
            final ValueSetCatalogEntryListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ValueSetCatalogEntryListEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ValueSetCatalogEntryListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ValueSetCatalogEntryListEntry[] getEntry(
        ...
        ValueSetCatalogEntryListEntry[] array = new ValueSetCatalogEntryListEntry[0];
     ...
     */
    public java.util.List<ValueSetCatalogEntryListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ValueSetCatalogEntryListEntry> iterateEntry(
    ) {
     ...
     */
    public ValueSetCatalogEntryListEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ValueSetCatalogEntryListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ValueSetCatalogEntryListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ValueSetCatalogEntryListEntry> entryList) {
