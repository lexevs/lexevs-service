...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<MultiNameNamespaceReference> _entryList;
    ...
    public NamespaceList() {
        super();
        this._entryList = new java.util.ArrayList<MultiNameNamespaceReference>();
    }
    ...
    public void addEntry(
            final MultiNameNamespaceReference vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends MultiNameNamespaceReference> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public MultiNameNamespaceReference getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public MultiNameNamespaceReference[] getEntry(
        ...
        MultiNameNamespaceReference[] array = new MultiNameNamespaceReference[0];
     ...
     */
    public java.util.List<MultiNameNamespaceReference> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends MultiNameNamespaceReference> iterateEntry(
    ) {
     ...
     */
    public MultiNameNamespaceReference removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final MultiNameNamespaceReference[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<MultiNameNamespaceReference> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<MultiNameNamespaceReference> entryList) {
