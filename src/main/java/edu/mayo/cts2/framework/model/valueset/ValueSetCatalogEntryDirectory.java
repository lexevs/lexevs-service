...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ValueSetCatalogEntrySummary> _entryList;
    ...
    public ValueSetCatalogEntryDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ValueSetCatalogEntrySummary>();
    }
    ...
    public void addEntry(
            final ValueSetCatalogEntrySummary vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ValueSetCatalogEntrySummary> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ValueSetCatalogEntrySummary getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ValueSetCatalogEntrySummary[] getEntry(
        ...
        ValueSetCatalogEntrySummary[] array = new ValueSetCatalogEntrySummary[0];
     ...
     */
    public java.util.List<ValueSetCatalogEntrySummary> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ValueSetCatalogEntrySummary> iterateEntry(
    ) {
     ...
     */
    public ValueSetCatalogEntrySummary removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ValueSetCatalogEntrySummary[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ValueSetCatalogEntrySummary> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ValueSetCatalogEntrySummary> entryList) {
