...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<EntityListEntry> _entryList;
    ...
    public EntityList() {
        super();
        this._entryList = new java.util.ArrayList<EntityListEntry>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends EntityListEntry> enumerateEntry(
    ) {
    ...
    public EntityListEntry[] getEntry(
        ...
        EntityListEntry[] array = new EntityListEntry[0];
     ...
     */
    public java.util.List<EntityListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends EntityListEntry> iterateEntry(
    ) {
     ...
     */
    public EntityListEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final EntityListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<EntityListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<EntityListEntry> entryList) {
