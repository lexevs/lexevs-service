...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ConceptDomainBindingDirectoryEntry> _entryList;
    ...
    public ConceptDomainBindingDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ConceptDomainBindingDirectoryEntry>();
    }
    ...
    public void addEntry(
            final ConceptDomainBindingDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ConceptDomainBindingDirectoryEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ConceptDomainBindingDirectoryEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ConceptDomainBindingDirectoryEntry[] getEntry(
        ...
        ConceptDomainBindingDirectoryEntry[] array = new ConceptDomainBindingDirectoryEntry[0];
     ...
     */
    public java.util.List<ConceptDomainBindingDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ConceptDomainBindingDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public ConceptDomainBindingDirectoryEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ConceptDomainBindingDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ConceptDomainBindingDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ConceptDomainBindingDirectoryEntry> entryList) {
