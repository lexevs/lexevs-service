...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ChangeSetDirectoryEntry> _entryList;
    ...
    public ChangeSetDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ChangeSetDirectoryEntry>();
    }
    ...
    public void addEntry(
            final ChangeSetDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ChangeSetDirectoryEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ChangeSetDirectoryEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ChangeSetDirectoryEntry[] getEntry(
        ...
        ChangeSetDirectoryEntry[] array = new ChangeSetDirectoryEntry[0];
     ...
     */
    public java.util.List<ChangeSetDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ChangeSetDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public ChangeSetDirectoryEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ChangeSetDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ChangeSetDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ChangeSetDirectoryEntry> entryList) {
