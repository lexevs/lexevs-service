...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ValueSetDefinitionDirectoryEntry> _entryList;
    ...
    public ValueSetDefinitionDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ValueSetDefinitionDirectoryEntry>();
    }
    ...
    public void addEntry(
            final ValueSetDefinitionDirectoryEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ValueSetDefinitionDirectoryEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ValueSetDefinitionDirectoryEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ValueSetDefinitionDirectoryEntry[] getEntry(
        ...
        ValueSetDefinitionDirectoryEntry[] array = new ValueSetDefinitionDirectoryEntry[0];
     ...
     */
    public java.util.List<ValueSetDefinitionDirectoryEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ValueSetDefinitionDirectoryEntry> iterateEntry(
    ) {
     ...
     */
    public ValueSetDefinitionDirectoryEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ValueSetDefinitionDirectoryEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ValueSetDefinitionDirectoryEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ValueSetDefinitionDirectoryEntry> entryList) {
