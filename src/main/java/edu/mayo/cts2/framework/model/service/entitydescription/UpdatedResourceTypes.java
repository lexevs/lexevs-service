...
implements java.io.Serializable
{
     ...
     */
    private java.util.List<EntityNameOrURI> _resourceTypeList;
    ...
    public UpdatedResourceTypes() {
        super();
        this._resourceTypeList = new java.util.ArrayList<EntityNameOrURI>();
    }
    ...
    public void addResourceType(
            final EntityNameOrURI vResourceType)
     ...
     * collection
     */
    public java.util.Enumeration<? extends EntityNameOrURI> enumerateResourceType(
    ) {
     ...
     * at the given index
     */
    public EntityNameOrURI getResourceType(
            final int index)
    throws IndexOutOfBoundsException {
     ...
     */
    public java.util.List<EntityNameOrURI> getResourceTypeAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends EntityNameOrURI> iterateResourceType(
    ) {
     ...
     */
    public EntityNameOrURI removeResourceTypeAt(
            final int index) {
     ...
     */
    public void setResourceType(
            final EntityNameOrURI[] vResourceTypeArray) {
        //-- copy array
     ...
     */
    public void setResourceType(
            final java.util.List<EntityNameOrURI> vResourceTypeList) {
        // copy vector
        this._resourceTypeList.clear();
    ...
    public void setResourceTypeAsReference(
            final java.util.List<EntityNameOrURI> resourceTypeList) {
