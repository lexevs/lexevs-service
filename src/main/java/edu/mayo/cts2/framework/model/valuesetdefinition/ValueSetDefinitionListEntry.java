...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ValueSetDefinition> _entryList;
    ...
    public ValueSetDefinitionListEntry() {
        super();
        this._entryList = new java.util.ArrayList<ValueSetDefinition>();
    }
    ...
    public void addEntry(
            final ValueSetDefinition vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ValueSetDefinition> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ValueSetDefinition getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ValueSetDefinition[] getEntry(
        ...
        ValueSetDefinition[] array = new ValueSetDefinition[0];
     ...
     */
    public java.util.List<ValueSetDefinition> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ValueSetDefinition> iterateEntry(
    ) {
     ...
     */
    public ValueSetDefinition removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ValueSetDefinition[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ValueSetDefinition> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ValueSetDefinition> entryList) {
