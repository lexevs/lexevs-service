...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<EntityNameOrURI> _entryList;
    ...
    public EntityNameOrURIList() {
        super();
        this._entryList = new java.util.ArrayList<EntityNameOrURI>();
    }
     ...
     * collection
     */
    public java.util.Enumeration<? extends EntityNameOrURI> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public EntityNameOrURI getEntry(
            final int index)
    throws IndexOutOfBoundsException {
     ...
     */
    public java.util.List<EntityNameOrURI> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends EntityNameOrURI> iterateEntry(
    ) {
     ...
     */
    public EntityNameOrURI removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final EntityNameOrURI[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<EntityNameOrURI> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<EntityNameOrURI> entryList) {
