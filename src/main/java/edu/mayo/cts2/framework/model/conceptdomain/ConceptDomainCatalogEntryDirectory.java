...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<ConceptDomainCatalogEntrySummary> _entryList;
    ...
    public ConceptDomainCatalogEntryDirectory() {
        super();
        this._entryList = new java.util.ArrayList<ConceptDomainCatalogEntrySummary>();
    }
    ...
    public void addEntry(
            final ConceptDomainCatalogEntrySummary vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends ConceptDomainCatalogEntrySummary> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public ConceptDomainCatalogEntrySummary getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public ConceptDomainCatalogEntrySummary[] getEntry(
        ...
        ConceptDomainCatalogEntrySummary[] array = new ConceptDomainCatalogEntrySummary[0];
     ...
     */
    public java.util.List<ConceptDomainCatalogEntrySummary> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends ConceptDomainCatalogEntrySummary> iterateEntry(
    ) {
     ...
     */
    public ConceptDomainCatalogEntrySummary removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final ConceptDomainCatalogEntrySummary[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<ConceptDomainCatalogEntrySummary> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<ConceptDomainCatalogEntrySummary> entryList) {
