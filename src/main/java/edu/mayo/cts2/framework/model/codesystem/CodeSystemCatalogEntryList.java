...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<CodeSystemCatalogEntryListEntry> _entryList;
    ...
    public CodeSystemCatalogEntryList() {
        super();
        this._entryList = new java.util.ArrayList<CodeSystemCatalogEntryListEntry>();
    }
    ...
    public void addEntry(
            final CodeSystemCatalogEntryListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends CodeSystemCatalogEntryListEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public CodeSystemCatalogEntryListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public CodeSystemCatalogEntryListEntry[] getEntry(
        ...
        CodeSystemCatalogEntryListEntry[] array = new CodeSystemCatalogEntryListEntry[0];
     ...
     */
    public java.util.List<CodeSystemCatalogEntryListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends CodeSystemCatalogEntryListEntry> iterateEntry(
    ) {
     ...
     */
    public CodeSystemCatalogEntryListEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final CodeSystemCatalogEntryListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<CodeSystemCatalogEntryListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<CodeSystemCatalogEntryListEntry> entryList) {
