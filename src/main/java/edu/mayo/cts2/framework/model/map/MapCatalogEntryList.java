...
implements java.io.Serializable
{
     ...
     * Field _entryList.
     */
    private java.util.List<MapCatalogEntryListEntry> _entryList;
    ...
    public MapCatalogEntryList() {
        super();
        this._entryList = new java.util.ArrayList<MapCatalogEntryListEntry>();
    }
    ...
    public void addEntry(
            final MapCatalogEntryListEntry vEntry)
     ...
     * collection
     */
    public java.util.Enumeration<? extends MapCatalogEntryListEntry> enumerateEntry(
    ) {
     ...
     * at the given index
     */
    public MapCatalogEntryListEntry getEntry(
            final int index)
    throws IndexOutOfBoundsException {
    ...
    public MapCatalogEntryListEntry[] getEntry(
        ...
        MapCatalogEntryListEntry[] array = new MapCatalogEntryListEntry[0];
     ...
     */
    public java.util.List<MapCatalogEntryListEntry> getEntryAsReference(
    ) {
     ...
     * collection
     */
    public java.util.Iterator<? extends MapCatalogEntryListEntry> iterateEntry(
    ) {
     ...
     */
    public MapCatalogEntryListEntry removeEntryAt(
            final int index) {
     ...
     */
    public void setEntry(
            final MapCatalogEntryListEntry[] vEntryArray) {
        //-- copy array
        _entryList.clear();
     ...
     */
    public void setEntry(
            final java.util.List<MapCatalogEntryListEntry> vEntryList) {
        // copy vector
        this._entryList.clear();
    ...
    public void setEntryAsReference(
            final java.util.List<MapCatalogEntryListEntry> entryList) {
